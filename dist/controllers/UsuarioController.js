...
exports.getUsuarios = (0, AsyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
...
exports.getUsuarioById = (0, AsyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
// Atualizar usuário
exports.updateUsuario = (0, AsyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
...
exports.deleteUsuario = (0, AsyncHandler_1.asyncHandler)((req, res) => __awaiter(void 0, void 0, void 0, function* () {
    const { id } = req.params;
    console.log(`DELETE /usuarios/${id} - Iniciando exclusão lógica do usuário com ID ${id}`);
    yield UsuarioService_1.UsuarioService.deleteUsuario(Number(id));
